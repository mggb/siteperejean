...
<body class="body">
  ...
  <footer class="container-footer ">
    ...
    <ul class="container-menu-footer">
      <a href="">
        <li class="menu-footer">acceuil</li>
      </a>
      <a href="">
        <li class="menu-footer">pack service</li>
      </a>
      <a href="">
        <li class="menu-footer">contacter nous</li>
      </a>
      <a href="">
        <li class="menu-footer">recrutement</li>
      </a>
      <a href="">
        <li class="menu-footer">lien utile</li>
      </a>
      <a href="">
        <li class="menu-footer">votre espace</li>
      </a>
    </ul>
